    ...
    <div class="sidebar-header">
        <div class="logo">
            <a href="{{ route('admin.dashboard') }}">
                ...
                <img src="{{ asset('wegro-bangla.png') }}" alt="wegro">
            </a>
        </div>
    </div>
    <div class="main-menu">
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @if ($usr && ($usr->can('role.create') || $usr->can('role.view') || $usr->can('role.edit') ||
                    $usr->can('role.delete')))
                    <li>
                    ...
                    @if ($usr && ($usr->can('admin.create') || $usr->can('admin.view') || $usr->can('admin.edit') ||
